...
): Promise<{ success: boolean; content: Content; message: string }> => {
...
export const createShareLink = async (): Promise<{
  success: boolean;
  hash: string;
  message: string;
}> => {
...
export const removeShareLink = async (): Promise<{
  success: boolean;
  message: string;
}> => {
...
export const getSharedBrain = async (
  shareLink: string
): Promise<{ success: boolean; username: string; content: Content[] }> => {
